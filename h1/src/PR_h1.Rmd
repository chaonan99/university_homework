...
for (lambda in c(0.001,0.003,0.01,0.03,0.1,0.3,1,3,10,30,100,300)){
	dat1.train.rie<-c(dat1.train.rie,sum((dat1.train.res>log(lambda))!=dat1.label)/nrow(dat1))
	dat2.test.rie<-c(dat2.test.rie,sum((dat2.test.res>log(lambda))!=dat2.label)/nrow(dat2))
	dat2.train.rie<-c(dat2.train.rie,sum((dat2.train.res>log(lambda))!=dat2.label)/nrow(dat2))
	dat1.test.rie<-c(dat1.test.rie,sum((dat1.test.res>log(lambda))!=dat1.label)/nrow(dat1))
}
dat1.train.rie
dat2.test.rie
dat2.train.rie
