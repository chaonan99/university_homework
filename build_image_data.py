...
tf.app.flags.DEFINE_string('train_directory',
  '/home/chenhaonan/data/Image/cup_dataset/train_img_forstu/',
  'Training data directory')
tf.app.flags.DEFINE_string('validation_directory',
  '/home/chenhaonan/data/Image/cup_dataset/valid_img_forstu/',
  'Validation data directory')
tf.app.flags.DEFINE_string('output_directory',
  '/home/chenhaonan/data/Image/cup_dataset',
...
def _find_image_files(data_dir, labels_file):
  ...
  with tf.gfile.FastGFile(os.path.join(data_dir, labels_file), 'r') as f:
    f.readline()
    texts = [l.strip().split()[1].encode('utf-8') for l in f.readlines()]

  labels = [int(x) + 1 for x in texts]
